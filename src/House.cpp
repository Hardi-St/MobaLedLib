...
/*
 Problem:                                                                                                     // 13.01.20:
 ~~~~~~~~
 Wenn GasLights_Inv() verwendet wird und der "Startwert" 1 ist, dann leuchtet zuff„llig eine LED
 gleich zu beginn schwach. Sie beh„t diese Helligkeit immer und l„sst sich nicht Ein- und
 Ausschalten.
 Wenn der "Startwert" 0 ist, dann funktioniert es richtig.
 Abhilfe:
 Es wurde ein !Initialize in die Zeile eingefgt:
