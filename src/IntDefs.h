...
#define P_CONST_VAL0           (3+ADD_LED_OFFSET+ADD_INCH_OFFSET)   // Const
#define P_CONST_VAL1           (4+ADD_LED_OFFSET+ADD_INCH_OFFSET)   //  "
#define EP_CONST_INCREMENT     (5+ADD_LED_OFFSET+ADD_INCH_OFFSET);
...
#define P_HOUSE_ON_MIN         (2+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_HOUSE_ON_MAX         (3+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_HOUSE_MIN_T          (4+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_HOUSE_MAX_T          (5+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_HOUSE_CNT            (6+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_HOUSE_ROOM_0         (7+ADD_LED_OFFSET+ADD_INCH_OFFSET)

#define P_FIRE_LED0            0
#define P_FIRE_INCH            (P_INPCHANEL_NO_CM+ADD_LED_OFFSET) // 1
#define P_FIRE_LEDCNT          (2+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_FIRE_BRIGHT          (3+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define EP_FIRE_INCREMENT      (4+ADD_LED_OFFSET+ADD_INCH_OFFSET)   // Insert additional parameters before
  
#define P_BUTTON_LED           0
#define P_BUTTON_CHMSK         (1+ADD_LED_OFFSET)
#define P_BUTTON_INCH          (P_INPCHANEL_W_CM+ADD_LED_OFFSET)   // 2
#define P_BUTTON_DURLO         (3+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_BUTTON_DURHI         (4+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_BUTTON_VAL0          (5+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_BUTTON_VAL1          (6+ADD_LED_OFFSET+ADD_INCH_OFFSET)

#define P_PATERN_LED           0
#define P_PATERN_NSTRU         (1+ADD_LED_OFFSET)
#define P_PATERN_INCH          (P_INPCHANEL_W_CM+ADD_LED_OFFSET)    // 2
#define P_PATERN_ENABLE        (3+ADD_LED_OFFSET+ADD_INCH_OFFSET)
#define P_PATERN_LEDS          (4+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2)) //  -+
#define P_PATERN_VAL0          (5+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2)) //   +  Attention: LEDs, Val0, Val1, Off are read at once.
#define P_PATERN_VAL1          (6+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2)) //   +  => Don't change the sequence of the parameters
#define P_PATERN_OFF           (7+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2)) //  -+
#define P_PATERN_MODE          (8+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2))
#define P_PATERN_T1_L          (9+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2))
#define P_PATERN_T1_H          (10+ADD_LED_OFFSET+(ADD_INCH_OFFSET*2))
...
#define P_RANDMUX_INP          (P_INPCHANEL_W_CM+2*ADD_INCH_OFFSET)   // 2
#define P_RANDMUX_MODE         (3+3*ADD_INCH_OFFSET)
#define P_RANDMUX_MINTIME_L    (4+3*ADD_INCH_OFFSET)
#define P_RANDMUX_MINTIME_H    (5+3*ADD_INCH_OFFSET)
#define P_RANDMUX_MAXTIME_L    (6+3*ADD_INCH_OFFSET)    // must be direct after P_RANDMUX_MINTIME_H
#define P_RANDMUX_MAXTIME_H    (7+3*ADD_INCH_OFFSET)
#define EP_RANDMUX_INCREMENT   (8+3*ADD_INCH_OFFSET)    // Insert additional parameters before


#define P_WELDING_LED          0
#define P_WELDING_INP          (1+ADD_LED_OFFSET)
#define EP_WELDING_INCREMENT   (2+ADD_LED_OFFSET+ADD_INCH_OFFSET)    // Insert additional parameters before

#if _USE_COPY_N_LEDS                                                                                          // 18.09.23:
  #define P_COPYLED_CNT        0
  #define P_COPYLED_LED        1
  #define P_COPYLED_INP        (2+ADD_LED_OFFSET)
  #define P_COPYLED_SRCLED     (3+ADD_LED_OFFSET+ADD_INCH_OFFSET)
  #define EP_COPYLED_INCREMENT (4+ADD_LED_OFFSET*2+ADD_INCH_OFFSET)    // Insert additional parameters before
#else
  #define P_COPYLED_LED          0
  #define P_COPYLED_INP          (1+ADD_LED_OFFSET)
  #define P_COPYLED_SRCLED       (2+ADD_LED_OFFSET+ADD_INCH_OFFSET)
  #define EP_COPYLED_INCREMENT   (3+ADD_LED_OFFSET*2+ADD_INCH_OFFSET)    // Insert additional parameters before
#endif

#define P_SCHEDULE_DSTVAR1     0
#define P_SCHEDULE_DSTVARN     (1+ADD_INCH_OFFSET)
#define P_SCHEDULE_INCH        (2+2*ADD_INCH_OFFSET)
#define P_SCHEDULE_START       (3+3*ADD_INCH_OFFSET)
#define P_SCHEDULE_END         (4+3*ADD_INCH_OFFSET)
#define EP_SCHEDULE_INCREMENT  (5+3*ADD_INCH_OFFSET)    // Insert additional parameters before

#define P_COUNT_MODE_L         0
#define P_COUNT_MODE_H         1
#define P_COUNT_INP            2
#define P_COUNT_ENABLE         (3+ADD_INCH_OFFSET)
#define P_COUNT_TIMEOUT_L      (4+ADD_INCH_OFFSET*2)
#define P_COUNT_TIMEOUT_H      (5+ADD_INCH_OFFSET*2)
#define P_COUNT_DEST_COUNT     (6+ADD_INCH_OFFSET*2)
#define P_COUNT_FIRST_DEST     (7+ADD_INCH_OFFSET*2)

#define P_LOGIC_DSTVAR        0
#define P_LOGIC_CNT           (1+ADD_INCH_OFFSET)
#define P_LOGIC_ARGS          (2+ADD_INCH_OFFSET)

#define P_SET_TV_TAB_INCH       0
#define P_SET_TV_TAB_CHANNEL    (1+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_T_MIN      (2+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_T_MAX      (3+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_BR_MIN     (4+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_BR_MAX     (5+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_R_MIN      (6+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_R_MAX      (7+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_G_MIN      (8+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_G_MAX      (9+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_B_MIN      (10+ADD_INCH_OFFSET)
#define P_SET_TV_TAB_B_MAX      (11+ADD_INCH_OFFSET)
#define EP_SET_TV_TAB_INCREMENT (12+ADD_INCH_OFFSET)    // Insert additional parameters before

#define P_SET_DEF_NEON_INCH      0
#define P_SET_DEF_NEON_RND_ON    (1+ADD_INCH_OFFSET)
#define P_SET_DEF_NEON_RND_OFF   (2+ADD_INCH_OFFSET)
#define P_SET_DEF_NEON_MIN_DEF   (3+ADD_INCH_OFFSET)
#define P_SET_DEF_NEON_INCREMENT (4+ADD_INCH_OFFSET)    // Insert additional parameters before
