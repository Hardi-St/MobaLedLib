...
// Begin MLL specific
#define PROG 9    // set pin to LOW to connect boot pins of LED Arduino with communication Arduino
// End MLL specific
...
// Begin MLL specific
  pinMode(PROG, OUTPUT);
  digitalWrite(PROG, LOW);  // set pin to LOW to connect LED Arduino with communication Arduino
// End MLL specific
...
void end_pmode() {
  ...
  pmode = 0;
// Begin MLL specific
  pinMode(PROG, INPUT);     // disconnect LED Arduino from communication Arduino
// End MLL specific
}
