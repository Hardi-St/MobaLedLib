@ECHO OFF
REM This file was generated by 'Pattern_Configurator.xlsm'  12:12:12
...
"%USERPROFILE%\AppData\Local\Arduino15\packages\arduino\tools\avrdude\6.3.0-arduino17\bin\avrdude.exe" ^
    "-C%USERPROFILE%\AppData\Local\Arduino15\packages\ATTinyCore\hardware\avr\1.4.1\avrdude.conf"  ^
    -v -pattiny85 -cstk500v1 -P%ComPort% -b19200 ^
    -Uefuse:w:0xFF:m -Uhfuse:w:0xD5:m -Ulfuse:w:0xF1:m
